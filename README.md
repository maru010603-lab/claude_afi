...
- 社員統括: Claude — 制作・分析・進行管理(サブエージェント+定期実行タスクで運営)

## 統括が行わないこと
アカウント作成、パスワード/APIキーの取り扱い、金銭情報の登録、投稿の最終公開、実リンクの生成、個別の金融・投資助言。
...
- [docs/asp_accounts.md](docs/asp_accounts.md) — ASP/媒体/ツール状況
